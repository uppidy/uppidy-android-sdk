...
public interface FeedOperations {
	 ...
	 * @return a list of {@link Message}s for the authenticated user. 
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getFeed(int offset, int limit);
	 ...
	 * @return a list of {@link Message}s for the specified user. 
	 * @throws ApiException if there is an error while communicating with Uppidy.
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getFeed(String ownerId);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getHomeFeed(int offset, int limit);

	/**
	 * Retrieves a single post.
	 * @param entryId the entry ID
	 * @return the requested {@link Message}
	 * @throws ApiException if there is an error while communicating with Uppidy.
	 */
	Message getPost(String entryId);
	
	/**
	 * Retrieves the post entries from the authenticated user's feed.
	 * Returns up to the most recent 25 posts.
	 * Requires "read_stream" permission. 
	 * @return a list of post {@link Message}s. 
	 * @throws ApiException if there is an error while communicating with Uppidy.
	 * @throws InsufficientPermissionException if the user has not granted "read_stream" permission.
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getPosts();
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getPosts(int offset, int limit);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getPosts(String ownerId);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> getPosts(String ownerId, int offset, int limit);
	 ...
	 * @return a list of {@link Message}s that match the search query
	 * @throws ApiException if there is an error while communicating with Uppidy.
	 */
	List<Message> searchPublicFeed(String query);
	 ...
	 * @throws ApiException if there is an error while communicating with Uppidy.
	 */
	List<Message> searchPublicFeed(String query, int offset, int limit);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchHomeFeed(String query);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchHomeFeed(String query, int offset, int limit);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchUserFeed(String query);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchUserFeed(String query, int offset, int limit);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchUserFeed(String userId, String query);
	 ...
	 * @throws MissingAuthorizationException if UppidyTemplate was not created with an access token.
	 */
	List<Message> searchUserFeed(String userId, String query, int offset, int limit);
