...
public interface UppidyApi {
	 ...
	 * @param objectId the Uppidy object's ID
	 ...
	 * @return a list of Java objects representing the Uppidy objects in the connections.
	 */
	 ...
	 * @param type the Java type that is expected in return
	 ...
	 */
	String publish(String objectId, String connectionName, Object data);	
